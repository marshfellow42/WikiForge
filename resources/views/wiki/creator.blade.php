...
<script>
    ...
    function addTopic() {
        ...
        <input type="text" class="form-control mb-2" placeholder="Nome do Tópico">
        <input type="text" class="form-control" placeholder="URL do Tópico">
        <button type="button" class="btn btn-danger mt-2" onclick="removeTopic(${topicCount})">Remover Tópico</button>
    `;
